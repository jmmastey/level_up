...
SKILLS = [
  ...
  [ "ruby_2", "gems", "Fluently uses gems, modules and metacode to separate concerns" ],
  ...
  [ "rails", "suites", "Knows the location and conventions for Rspec and Cucumber" ],
  ...
  [ "test", "tdd", "Understands TDD and BDD" ],
  ...
  [ "interaction", "console", "Uses the Developer Console for debugging" ],
  ...
  [ "cnuapp", "clusters", "Understands clusters vs countries vs brands" ],
  [ "cnuapp", "heads", "Knows the different Rails heads" ],
  [ "cnuapp", "rake", "Knows common Cnuapp rake tasks" ],
