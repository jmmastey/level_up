Levelup::Application.configure do
  ...
  config.ssl_options  = { hsts: { expires: 365.days, subdomains: true, preload: true } }
  ...
  config.action_controller.asset_host = ENV.fetch('CDN_HOST', nil)
  ...
  config.action_mailer.smtp_settings = {
    from: "Joe @ LevelUpRails <jmmastey@gmail.com>",
