...
Devise.setup do |config|
  ...
  config.mailer_sender = 'jmmastey@gmail.com'
  ...
  # session. If you need permissions, implement them in a before filter.
  ...
  # config.pepper = 'c1e242cddf216302546bb98750d40f2109f5e139520793329a68ee222'
  ...
  # :failed_attempts = Locks an account after a number of failed sign ins.
  ...
  config.omniauth :github, (ENV['GITHUB_CLIENT_ID'] || "fixme_in_dotenv"),
    (ENV['GITHUB_CLIENT_SECRET'] || "fixme_in_dotenv"),
